...
#define LOGICAL_EM_EEPROM_SIZE      (NUMSENSORS * sizeof(int32_t)) /* 48 bytes for 12 int32_t values */
 ...
 */
#define EM_EEPROM_SIZE              (128u) /* At least one flash row, adjust based on device */
...
* External variables
*******************************************************************************/
extern int32_t sensorEmptyOffset[NUMSENSORS];
